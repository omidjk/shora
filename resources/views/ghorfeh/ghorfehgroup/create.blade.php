...
@section('content')
    ...
    <div class="card uper">
        ...
        <div class="card-body">
            ...
            @endif
            <form method="post" action="{{ route('ghorfehgroup.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" onkeypress="return isNumberKey(event)" minlength="3" maxlength="5" class="form-control" name="group_code"/>
                </div>
