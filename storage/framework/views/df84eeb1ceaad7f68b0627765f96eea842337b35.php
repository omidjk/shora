...
<head>
    ...
    <link href="<?php echo e(menu_asset('/css/menu.css')); ?>" rel="stylesheet" type="text/css" />
	<!-- Theme style -->
    ...
    <div class="sidebar">
      <div>
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a  class="d-block">نام کاربر : <?php echo e(Auth::user()->name); ?> <span class="caret"></span></a>
          </div>
        </div>
...
<?php /**PATH D:\PhpstormProjects\shora\resources\views/layouts/app2.blade.php ENDPATH**/ ?>