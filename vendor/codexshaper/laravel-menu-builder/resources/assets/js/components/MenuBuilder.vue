                    ...
                    <div class="col-md-12">
                        <div class="create-btn">
                            <button  
                                ...
                                data-toggle="modal" 
                                data-target="#addMenuItemModal"> افزودن منو</button>
                            <button  
                                v-on:click="showSettingsForm"
                                class="btn btn-info edit-info" 
                                data-toggle="modal" 
                                data-target="#settingsModal"> تنظیمات</button>
                            <button
                                id="show_menu_design"  
                                class="btn btn-info edit-info"
                                :data-id="menu.id" 
                                :data-prefix="prefix" 
                                data-toggle="modal" 
                                data-target="#showMenuModel"> مشاهده منوها</button>
								<button
                                id="show_menu_design"  
                                class="btn btn-info edit-info"
                                :data-id="menu.id" 
                                :data-prefix="prefix" 
                                data-toggle="modal" 
                                data-target="#showMenuModel"> بازگشت</button>
                        </div>

                    </div>
                    <div class="col-md-12" >
                        <div class="use-menu text-md-right">
                             <p>برای استفاده از این منو فقط کافیت  فرمت روبرو را فراخوانی نمایید <span class="menu-code"> menu('{{ menu.slug }}')</span> یا <span class="menu-code"> @menu('{{ menu.slug }}')</span></p>
                        </div>
                    </div>
                </div>
