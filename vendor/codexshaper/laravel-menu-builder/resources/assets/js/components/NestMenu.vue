                ...
                <div class="row">
                    <div class="create-btn col-md-12">
                       <button  
                           ...
                           data-toggle="modal" 
                           data-target="#addMenuModal"> افزودن منو</button>

                     </div>
                     <div class="col-md-12">
                        <div class="use-menu text-md-right">
                             <p>برای استفاده از این منو فقط کافیست  فرمت روبرو را فراخوانی نمایید  <span class="menu-code">menu('name')</span> یا <span class="menu-code"> @menu('name')</span></p>
                        </div>
                     </div>
                                ...
                                <tbody>
                                    <tr v-for="menu in menus" :key="menu.id">
                                        ...
                                        <td class="action-buttons">
                                            <a :href="prefix+'/menu/builder/'+menu.id" class="btn  btn-build-menu" title="menu build">منو ساز</a>
                                            <button 
